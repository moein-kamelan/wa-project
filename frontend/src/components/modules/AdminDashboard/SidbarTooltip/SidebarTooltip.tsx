...
function SidebarToolTip({children}: {children: React.ReactNode}) {
  return (
    <div className=" transition-all duration-300 opacity-0 invisible absolute right-[calc(100%+14px)] top-0 bottom-0 my-auto bg-secondary text-white  py-2 px-3 rounded-[4px] h-fit text-nowrap
    group-hover:delay-800 group-hover:opacity-100 group-hover:visible group-hover:duration-300">
              <span>{children}</span>
              <svg className="absolute top-0 bottom-0 my-auto left-[calc(100%-2px)]" width="11" height="18" viewBox="0 0 11 18" fill="none" xmlns="http://www.w3.org/2000/svg">

  ...
  [&::-webkit-scrollbar-thumb]:bg-[#1DA45070]"
        >
          {data?.campaigns?.map((campaign: any) => (
            <div
              key={campaign._id}
              className="bg-white px-10.5 py-[21px] grid grid-cols-[1fr_1fr_1fr_1fr_24px] items-center justify-center rounded-tl-[6px] rounded-tr-[6px] text-2xl shadow-[2px_-4px_4px_0px_rgba(0,0,0,0.25)]"
            >
              <div className="flex items-center gap-2">
            <svg className="shrink-0" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M18.3332 10.8333V12.4999C18.3332 16.6666 16.6665 18.3333 12.4998 18.3333H7.49984C3.33317 18.3333 1.6665 16.6666 1.6665 12.4999V11.2333" stroke="#25D366" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M9.1665 1.66675H7.49984C3.33317 1.66675 1.6665 3.33341 1.6665 7.50008" stroke="#25D366" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M16.6082 7.5083L17.4832 6.6333C18.6166 5.49997 19.1499 4.1833 17.4832 2.51663C15.8166 0.849966 14.4999 1.3833 13.3666 2.51663L6.7999 9.0833C6.5499 9.3333 6.2999 9.82497 6.2499 10.1833L5.89157 12.6916C5.75823 13.6 6.3999 14.2333 7.30823 14.1083L9.81657 13.75C10.1666 13.7 10.6582 13.45 10.9166 13.2L13.5666 10.55L14.1749 9.94163" stroke="#25D366" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M12.4248 3.45825C12.9831 5.44992 14.5415 7.00825 16.5415 7.57492" stroke="#25D366" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

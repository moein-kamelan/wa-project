...
import CampaignItem from "../../../components/templates/Dashboard/Campaigns/CampaignItem/CampaignItem.js";
import Pagination from "../../../components/modules/Pagination/Pagination.js";
...
function Campaigns() {
  ...
  [&::-webkit-scrollbar-thumb]:bg-[#1DA45070] "
          ...
          <div className=" bg-white/55 blur-[150] rounded-2xl shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] mx-auto">
            <Pagination

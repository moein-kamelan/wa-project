      ...
      case "running":
       {
        return (
               ...
               <div className="flex items-center justify-center btn-shadow  border border-primary rounded-[55px] text-2xl text-white [-webkit-text-stroke:0.8px_#25d366]
               w-[136px] h-10.5 relative z-20 overflow-hidden text-nowrap text-center">
          در حال ارسال
          <div className="absolute bg-primary  right-[80%] rounded-[55px] top-0 bottom-0 w-full -z-10">
...
<path d="M21 22.75C20.02 22.75 19.25 21.9625 19.25 21C19.25 20.0375 20.0375 19.25 21 19.25C21.9625 19.25 22.75 20.0375 22.75 21C22.75 21.9625 21.98 22.75 21 22.75Z" fill="#292D32"/>
<path d="M28 22.75C27.02 22.75 26.25 21.9625 26.25 21C26.25 20.0375 27.0375 19.25 28 19.25C28.9625 19.25 29.75 20.0375 29.75 21C29.75 21.9625 28.98 22.75 28 22.75Z" fill="#292D32"/>
<path d="M14 22.75C13.02 22.75 12.25 21.9625 12.25 21C12.25 20.0375 13.0375 19.25 14 19.25C14.9625 19.25 15.75 20.0375 15.75 21C15.75 21.9625 14.98 22.75 14 22.75Z" fill="#292D32"/>
</svg>
...
{openModalId ? <CampaignModal setOpenModalId={setOpenModalId}/> : (
